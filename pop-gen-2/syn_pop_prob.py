...
def joint_rvs(N, alpha, m_min, m_max, M_max, sigma_ecc, rand_state=None): # same as in new_powerlaw_mcmc, but need to change it
    r"""
    ...
    def rvs(N): # need to generate rvs with three colums and third should be ecc
        ...
        ecc = st.truncnorm.rvs(0,1,loc=0.1,scale=sigma_ecc, size=N)

        return numpy.column_stack((m_1, m_2, ecc))
