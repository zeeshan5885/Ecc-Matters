...
\caption{\label{fig:pop3d0.15_0.2} Synthetic Population of EBBHs. The left figure represents the population for $\sigma_\epsilon=0.15$ and right figure represents the population for $\sigma_\epsilon=0.2$}
