...
\begin{itemize}
    ...
    \item eccentricity is a signature that can be measured with GWs
...
\begin{itemize}
    ...
    \item Some events may have unabmoguis eccentricity (refs to PE, Richard will send them), but many will have only faint signatures or none at all.
    \item critical for astrophysics to acces distribution of eccentricities and any subpopulation
\end{itemize}
Previous work
\begin{itemize}
    \item What other people have done with eccentricity, 
    \item cite any previous work related to eccentricity with population.
    \item mostly it's real events or high mass events
    \item what sort of eccentricity we expect to appear
\end{itemize}
\begin{itemize}
    \item Explain, what and how you are doing here.
    \item assesses how well the eccentricity of the population  can be inferred using low mass BHS where eccentricity measurement should be much more precise.
...
\subsection{Synthetic parameter inference with eccentricity}
